...
const MyJobs = () => {
  ...
  const handeEnableEdit = (jobId) => {
    setEditingMode(jobId);
  }

  // function for disabling editing Mode
  const handeDisableEdit = () => {
    setEditingMode(null);
  }
      ...
      <div className="myJobs page">
        <div className="container">
          ...
          {myJobs.length > 0 ? (
                        ...
                        <div className="content">
                          <div className="short_fields">
                            ...
                            <div>
                              ...
                              <select name="" id="" value={element.category}
                            ...
                            <div>
                              <span>
                                Salary: {element.fixedSalary ? <input type='number' value={element.fixedSalary}
                                  onChange={(e) => handleInputChange(element._id, "fixed salary", e.target.value)}
                                  disabled={editingMode !== element._id ? true : false} /> :
                                  (<div>
                                    ...
                                    <input type='number' value={element.salaryTo}
                                      onChange={(e) => handleInputChange(element._id, "salary To", e.target.value)}
                                      disabled={editingMode !== element._id ? true : false} />
                                  </div>)}
                              </span>
                              </div>
                          ...
                          <div className="edit_btn_wrapper">
                            {
                              editingMode===element._id?(
                                ...
                                <button onClick={()=>handeDisableEdit()} className='cross_btn'>
                                  <RxCross2/>
                                </button>
                                </>
                              ):(
                                <button onClick={()=>handeEnableEdit(element._id)} className='edit_btn'>Edit</button>
                              )
                            }
                          </div>
            ...
            : (
              <p>
                you have not posted any job or maybe you all deleted all of your jobs
              </p>
            )}
        </div>
      </div>
